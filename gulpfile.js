...
gulp.task('js', function() {
	return gulp.src([
		...
		'app/libs/rellax-master/rellax.min.js',
...
gulp.task('build', gulp.series('removedist', 'imagemin', 'sass', 'js', 'common-js', 'buildFiles', 'buildCss', 'buildJs', 'buildFonts'));
...
gulp.task('default', gulp.parallel('sass', 'js', 'common-js', 'browser-sync', 'watch'));
